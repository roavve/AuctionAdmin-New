...
public class AuctionRevisionFile extends MainEntity implements Serializable {
    ...
    public AuctionRevision getRevision() { return revision; }
    public void setRevision(AuctionRevision revision) { this.revision = revision; }
